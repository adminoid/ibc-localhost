...
import (
	...
	ptypes "github.com/evmos/cosmos-sdk/pruning/types"
	"github.com/cosmos/cosmos-sdk/server"
	"github.com/cosmos/cosmos-sdk/server/api"
	srvconfig "github.com/cosmos/cosmos-sdk/server/config"
	servertypes "github.com/cosmos/cosmos-sdk/server/types"
	"github.com/evmos/cosmos-sdk/simapp"
	"github.com/evmos/cosmos-sdk/simapp/params"
...
// NewAppConstructor returns a new DSC AppConstructor
func NewAppConstructor(encodingCfg params.EncodingConfig) AppConstructor {
	return func(val Validator) servertypes.Application {
		return app.NewDSC(
			...
			baseapp.SetPruning(ptypes.NewPruningOptionsFromString(val.AppConfig.Pruning)),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "dscd")
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "dsccli")
